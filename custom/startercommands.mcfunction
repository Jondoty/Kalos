...
#Items
give @a[x=-553,y=99,z=1256,dx=2,dy=3,dz=3] minecraft:carrot_on_a_stick 1 0 {display:{Lore:["A device that allows users","to receive hologram clips.","","It is also used to listen","to music while in your off-hand."]},HideFlags:63}
