...
execute as @s[x=246,y=85,z=402,distance=..5,tag=!ItemLoot17] run tellraw @s {"text":"You received X-Attacks and X-Defenses!","italic":true,"color":"gray"}
...
execute as @s[x=125,y=100,z=-68,distance=..5,tag=!ItemLoot29] run tellraw @s {"text":"You found a Net Ball!","italic":true,"color":"gray"}
...
execute as @s[x=-240,y=121,z=89,distance=..5,tag=ItemLoot42] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-240,y=121,z=89,distance=..5,tag=!ItemLoot42] run givetm falseswipe @s
execute as @s[x=-240,y=121,z=89,distance=..5,tag=!ItemLoot42] run tellraw @s {"text":"You received the TM False Swipe!","italic":true,"color":"gray"}
execute as @s[x=-240,y=121,z=89,distance=..5,tag=!ItemLoot42] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-240,y=121,z=89,distance=..5,tag=!ItemLoot42] run tag @s add ItemLoot42
...
execute as @s[x=-353,y=141,z=356,distance=..5,tag=ItemLoot42] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-353,y=141,z=356,distance=..5,tag=!ItemLoot42] run givetm taunt @s
execute as @s[x=-353,y=141,z=356,distance=..5,tag=!ItemLoot42] run tellraw @s {"text":"You received the TM Taunt!","italic":true,"color":"gray"}
execute as @s[x=-353,y=141,z=356,distance=..5,tag=!ItemLoot42] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-353,y=141,z=356,distance=..5,tag=!ItemLoot42] run tag @s add ItemLoot42
...
execute as @s[x=-364,y=89,z=349,distance=..5,tag=ItemLoot60] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-364,y=89,z=349,distance=..5,tag=!ItemLoot60] run give @s cobblemon:revive
execute as @s[x=-364,y=89,z=349,distance=..5,tag=!ItemLoot60] run tellraw @s {"text":"You found a Revive!","italic":true,"color":"gray"}
execute as @s[x=-364,y=89,z=349,distance=..5,tag=!ItemLoot60] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-364,y=89,z=349,distance=..5,tag=!ItemLoot60] run tag @s add ItemLoot60

execute as @s[x=-364,y=29,z=349,distance=..5,tag=ItemLoot60] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-364,y=29,z=349,distance=..5,tag=!ItemLoot60] run give @s cobblemon:revive
execute as @s[x=-364,y=29,z=349,distance=..5,tag=!ItemLoot60] run tellraw @s {"text":"You found a Revive!","italic":true,"color":"gray"}
execute as @s[x=-364,y=29,z=349,distance=..5,tag=!ItemLoot60] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-364,y=29,z=349,distance=..5,tag=!ItemLoot60] run tag @s add ItemLoot60
...
execute as @s[x=-244,y=89,z=338,distance=..5,tag=ItemLoot61] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-244,y=89,z=338,distance=..5,tag=!ItemLoot61] run give @s cobblemon:black_glasses
execute as @s[x=-244,y=89,z=338,distance=..5,tag=!ItemLoot61] run tellraw @s {"text":"You found Black Glasses!","italic":true,"color":"gray"}
execute as @s[x=-244,y=89,z=338,distance=..5,tag=!ItemLoot61] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-244,y=89,z=338,distance=..5,tag=!ItemLoot61] run tag @s add ItemLoot61

execute as @s[x=-244,y=29,z=338,distance=..5,tag=ItemLoot61] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-244,y=29,z=338,distance=..5,tag=!ItemLoot61] run give @s cobblemon:black_glasses
execute as @s[x=-244,y=29,z=338,distance=..5,tag=!ItemLoot61] run tellraw @s {"text":"You found Black Glasses!","italic":true,"color":"gray"}
execute as @s[x=-244,y=29,z=338,distance=..5,tag=!ItemLoot61] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-244,y=29,z=338,distance=..5,tag=!ItemLoot61] run tag @s add ItemLoot61
...
execute as @s[x=-299,y=89,z=282,distance=..5,tag=ItemLoot62] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-299,y=89,z=282,distance=..5,tag=!ItemLoot62] run give @s cobblemon:hyper_potion
execute as @s[x=-299,y=89,z=282,distance=..5,tag=!ItemLoot62] run tellraw @s {"text":"You found a Hyper Potion!","italic":true,"color":"gray"}
execute as @s[x=-299,y=89,z=282,distance=..5,tag=!ItemLoot62] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-299,y=89,z=282,distance=..5,tag=!ItemLoot62] run tag @s add ItemLoot62

execute as @s[x=-299,y=29,z=282,distance=..5,tag=ItemLoot62] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-299,y=29,z=282,distance=..5,tag=!ItemLoot62] run give @s cobblemon:hyper_potion
execute as @s[x=-299,y=29,z=282,distance=..5,tag=!ItemLoot62] run tellraw @s {"text":"You found a Hyper Potion!","italic":true,"color":"gray"}
execute as @s[x=-299,y=29,z=282,distance=..5,tag=!ItemLoot62] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-299,y=29,z=282,distance=..5,tag=!ItemLoot62] run tag @s add ItemLoot62
...
execute as @s[x=-332,y=89,z=359,distance=..5,tag=ItemLoot63] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-332,y=89,z=359,distance=..5,tag=!ItemLoot63] run give @s cobblemon:rare_candy
execute as @s[x=-332,y=89,z=359,distance=..5,tag=!ItemLoot63] run tellraw @s {"text":"You found a Rare Candy!","italic":true,"color":"gray"}
execute as @s[x=-332,y=89,z=359,distance=..5,tag=!ItemLoot63] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-332,y=89,z=359,distance=..5,tag=!ItemLoot63] run tag @s add ItemLoot63

execute as @s[x=-332,y=29,z=359,distance=..5,tag=ItemLoot63] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-332,y=29,z=359,distance=..5,tag=!ItemLoot63] run give @s cobblemon:rare_candy
execute as @s[x=-332,y=29,z=359,distance=..5,tag=!ItemLoot63] run tellraw @s {"text":"You found a Rare Candy!","italic":true,"color":"gray"}
execute as @s[x=-332,y=29,z=359,distance=..5,tag=!ItemLoot63] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-332,y=29,z=359,distance=..5,tag=!ItemLoot63] run tag @s add ItemLoot63

execute as @s[x=-444,y=144,z=323,distance=..5,tag=ItemLoot65] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-444,y=144,z=323,distance=..5,tag=!ItemLoot65] run givetm echoedvoice  @s
execute as @s[x=-444,y=144,z=323,distance=..5,tag=!ItemLoot65] run tellraw @s {"text":"You received the TM Echoed Voice!","italic":true,"color":"gray"}
execute as @s[x=-444,y=144,z=323,distance=..5,tag=!ItemLoot65] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-444,y=144,z=323,distance=..5,tag=!ItemLoot65] run tag @s add ItemLoot65

execute as @s[x=-114,y=77,z=346,distance=..5,tag=ItemLoot66] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-114,y=77,z=346,distance=..5,tag=!ItemLoot66] run givetm dragontail   @s
execute as @s[x=-114,y=77,z=346,distance=..5,tag=!ItemLoot66] run tellraw @s {"text":"You received the TM Dragon Tail!","italic":true,"color":"gray"}
execute as @s[x=-114,y=77,z=346,distance=..5,tag=!ItemLoot66] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-114,y=77,z=346,distance=..5,tag=!ItemLoot66] run tag @s add ItemLoot66
...
execute as @s[x=-358,y=101,z=90,distance=..5,tag=!ItemLoot67] run tellraw @s {"text":"You received a Miracle Seed!","italic":true,"color":"gray"}
...
execute as @s[x=-371,y=101,z=91,distance=..5,tag=!ItemLoot68] run tellraw @s {"text":"You received a Quick Claw!","italic":true,"color":"gray"}
...
execute as @s[x=-352,y=111,z=87,distance=..5,tag=!ItemLoot69] run tellraw @s {"text":"You received 3 Quick Balls!","italic":true,"color":"gray"}
...
execute as @s[x=-349,y=111,z=87,distance=..5,tag=!ItemLoot70] run tellraw @s {"text":"You received 3 Timer Balls!","italic":true,"color":"gray"}
...
execute as @s[x=-777,y=100,z=-98,distance=..5,tag=!ItemLoot82] run give @s cobblemon:oran_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=-897,y=102,z=-151,distance=..5,tag=ItemLoot83] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-897,y=102,z=-151,distance=..5,tag=!ItemLoot83] run givetm honeclaws @s
execute as @s[x=-897,y=102,z=-151,distance=..5,tag=!ItemLoot83] run tellraw @s {"text":"You received the TM Hone Claws!","italic":true,"color":"gray"}
execute as @s[x=-897,y=102,z=-151,distance=..5,tag=!ItemLoot83] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-897,y=102,z=-151,distance=..5,tag=!ItemLoot83] run tag @s add ItemLoot83
...
execute as @s[x=-1004,y=83,z=-55,distance=..5,tag=ItemLoot87] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1004,y=83,z=-55,distance=..5,tag=!ItemLoot87] run givetm thief @s
execute as @s[x=-1004,y=83,z=-55,distance=..5,tag=!ItemLoot87] run tellraw @s {"text":"You received the TM Thief!","italic":true,"color":"gray"}
execute as @s[x=-1004,y=83,z=-55,distance=..5,tag=!ItemLoot87] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1004,y=83,z=-55,distance=..5,tag=!ItemLoot87] run tag @s add ItemLoot87
...
execute as @s[x=-1112,y=72,z=-2,distance=..5,tag=!ItemLoot97] run tellraw @s {"text":"You received a Full Heal!","italic":true,"color":"gray"}
...
execute as @s[x=-1076,y=100,z=102,distance=..5,tag=!ItemLoot98] run tellraw @s {"text":"You received $6,000!","italic":true,"color":"gray"}
...
execute as @s[x=-1058,y=100,z=104,distance=..5,tag=!ItemLoot99] run tellraw @s {"text":"You received an Ether!","italic":true,"color":"gray"}
...
execute as @s[x=-1706,y=106,z=59,distance=..5,tag=!ItemLoot108] run give @s cobblemon:persim_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=-1711,y=106,z=64,distance=..5,tag=!ItemLoot109] run tellraw @s {"text":"You received $250!","italic":true,"color":"gray"}
...
execute as @s[x=-1325,y=100,z=-209,distance=..5,tag=!ItemLoot115] run give @s cobblemon:aguav_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=-1198,y=100,z=-276,distance=..5,tag=!ItemLoot118] run tellraw @s {"text":"You received $250!","italic":true,"color":"gray"}
...
execute as @s[x=-444,y=144,z=323,distance=..5,tag=ItemLoot119] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-444,y=144,z=323,distance=..5,tag=!ItemLoot119] run givetm venoshock  @s
execute as @s[x=-444,y=144,z=323,distance=..5,tag=!ItemLoot119] run tellraw @s {"text":"You found the TM Venoshock!","italic":true,"color":"gray"}
execute as @s[x=-444,y=144,z=323,distance=..5,tag=!ItemLoot119] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-444,y=144,z=323,distance=..5,tag=!ItemLoot119] run tag @s add ItemLoot119
...
execute as @s[x=-1296,y=100,z=-351,distance=..5,tag=!ItemLoot121] run give @s cobblemon:oran_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=-1670,y=100,z=-422,distance=..5,tag=!ItemLoot126] run tellraw @s {"text":"You received $500!","italic":true,"color":"gray"}
...
execute as @s[x=-1554,y=100,z=-325,distance=..5,tag=!Cut] run givetm cut @s
...
execute as @s[x=-1827,y=48,z=-21,distance=..5,tag=ItemLoot136] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1827,y=48,z=-21,distance=..5,tag=!ItemLoot136] run givetm aerialace  @s
execute as @s[x=-1827,y=48,z=-21,distance=..5,tag=!ItemLoot136] run tellraw @s {"text":"You found the TM Aerial Ace!","italic":true,"color":"gray"}
execute as @s[x=-1827,y=48,z=-21,distance=..5,tag=!ItemLoot136] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1827,y=48,z=-21,distance=..5,tag=!ItemLoot136] run tag @s add ItemLoot136

execute as @s[x=-1790,y=44,z=40,distance=..5,tag=ItemLoot137] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1790,y=44,z=40,distance=..5,tag=!ItemLoot137] run givetm frustration  @s
execute as @s[x=-1790,y=44,z=40,distance=..5,tag=!ItemLoot137] run tellraw @s {"text":"You received the TM Frustration!","italic":true,"color":"gray"}
execute as @s[x=-1790,y=44,z=40,distance=..5,tag=!ItemLoot137] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1790,y=44,z=40,distance=..5,tag=!ItemLoot137] run tag @s add ItemLoot137
...
execute as @s[x=-2041,y=100,z=379,distance=..5,tag=!ItemLoot143] run give @s cobblemon:mago_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=-2004,y=100,z=372,distance=..5,tag=!ItemLoot145] run tellraw @s {"text":"You received $1,000!","italic":true,"color":"gray"}
...
execute as @s[x=-2012,y=100,z=409,distance=..5,tag=!ItemLoot146] run tellraw @s {"text":"You received $1,500!","italic":true,"color":"gray"}
...
execute as @s[x=-2004,y=141,z=571,distance=..5,tag=!RockSmash] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-2004,y=141,z=571,distance=..5,tag=!RockSmash] run givetm rocksmash @s
execute as @s[x=-2004,y=141,z=571,distance=..5,tag=!RockSmash] run tag @s add RockSmash

execute as @s[x=-2156,y=100,z=179,distance=..5,tag=ItemLoot151] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-2156,y=100,z=179,distance=..5,tag=!ItemLoot151] run givetm roost  @s
execute as @s[x=-2156,y=100,z=179,distance=..5,tag=!ItemLoot151] run tellraw @s {"text":"You found the TM Roost!","italic":true,"color":"gray"}
execute as @s[x=-2156,y=100,z=179,distance=..5,tag=!ItemLoot151] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-2156,y=100,z=179,distance=..5,tag=!ItemLoot151] run tag @s add ItemLoot151
...
execute as @s[x=-1953,y=100,z=647,distance=..5,tag=ItemLoot156] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1953,y=100,z=647,distance=..5,tag=!ItemLoot156] run givetm naturepower  @s
execute as @s[x=-1953,y=100,z=647,distance=..5,tag=!ItemLoot156] run tellraw @s {"text":"You received the TM Nature Power!","italic":true,"color":"gray"}
execute as @s[x=-1953,y=100,z=647,distance=..5,tag=!ItemLoot156] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1953,y=100,z=647,distance=..5,tag=!ItemLoot156] run tag @s add ItemLoot156
...
execute as @s[x=-1947,y=141,z=594,distance=..5,tag=!ItemLoot157] run give @s mega_showdown:shock_drive
execute as @s[x=-1947,y=141,z=594,distance=..5,tag=!ItemLoot157] run give @s mega_showdown:burn_drive
execute as @s[x=-1947,y=141,z=594,distance=..5,tag=!ItemLoot157] run give @s mega_showdown:douse_drive
execute as @s[x=-1947,y=141,z=594,distance=..5,tag=!ItemLoot157] run give @s mega_showdown:chill_drive
execute as @s[x=-1947,y=141,z=594,distance=..5,tag=!ItemLoot157] run tellraw @s {"text":"You received Drives!","italic":true,"color":"gray"}
...
execute as @s[x=-1868,y=141,z=629,distance=..5,tag=!ItemLoot158] run tellraw @s {"text":"You received a Rocky Helmet!","italic":true,"color":"gray"}
...
execute as @s[x=-2015,y=133,z=531,distance=..5,tag=!ItemLoot159] run tellraw @s {"text":"You received an Old Rod!","italic":true,"color":"gray"}
...
execute as @s[x=-2032,y=100,z=605,distance=..5,tag=!ItemLoot161] run tellraw @s {"text":"You received $1,000!","italic":true,"color":"gray"}
...
execute as @s[x=-1500,y=148,z=383,distance=..5,tag=ItemLoot170] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1500,y=148,z=383,distance=..5,tag=!ItemLoot170] run givetm shadowclaw  @s
execute as @s[x=-1500,y=148,z=383,distance=..5,tag=!ItemLoot170] run tellraw @s {"text":"You found the TM Shadow Claw!","italic":true,"color":"gray"}
execute as @s[x=-1500,y=148,z=383,distance=..5,tag=!ItemLoot170] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1500,y=148,z=383,distance=..5,tag=!ItemLoot170] run tag @s add ItemLoot170
...
execute as @s[x=-1469,y=148,z=306,distance=..10,scores={Temp=1},tag=ItemLoot172] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1469,y=148,z=306,distance=..10,scores={Temp=1},tag=!ItemLoot172] run give @s cobblemon:jaw_fossil
execute as @s[x=-1469,y=148,z=306,distance=..10,scores={Temp=1},tag=!ItemLoot172] run tellraw @s {"text":"You received the Jaw Fossil!","italic":true,"color":"gray"}
execute as @s[x=-1469,y=148,z=306,distance=..10,scores={Temp=1},tag=!ItemLoot172] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1469,y=148,z=306,distance=..10,scores={Temp=1},tag=!ItemLoot172] run tag @s add ItemLoot172

execute as @s[x=-1469,y=148,z=306,distance=..10,scores={Temp=2},tag=ItemLoot173] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1469,y=148,z=306,distance=..10,scores={Temp=2},tag=!ItemLoot173] run give @s cobblemon:sail_fossil
execute as @s[x=-1469,y=148,z=306,distance=..10,scores={Temp=2},tag=!ItemLoot173] run tellraw @s {"text":"You received the Sail Fossil!","italic":true,"color":"gray"}
execute as @s[x=-1469,y=148,z=306,distance=..10,scores={Temp=2},tag=!ItemLoot173] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1469,y=148,z=306,distance=..10,scores={Temp=2},tag=!ItemLoot173] run tag @s add ItemLoot173
...
execute as @s[x=-1968,y=101,z=-3,distance=..5,tag=!ItemLoot174] run tellraw @s {"text":"You received a Whipped Dream & Sachet!","italic":true,"color":"gray"}
...
execute as @s[x=-1199,y=85,z=-11,distance=..5,tag=!ItemLoot175] run tellraw @s {"text":"You received Oran and Pecha Berries!","italic":true,"color":"gray"}
...
execute as @s[x=-2194,y=100,z=-114,distance=..5,tag=!ItemLoot189] run tellraw @s {"text":"You received $1,000!","italic":true,"color":"gray"}
...
execute as @s[x=-2190,y=101,z=1,distance=..5,tag=!ItemLoot190] run give @s cobblemon:charti_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=-2099,y=104,z=-284,distance=..5,tag=!ItemLoot192] run give @s cobblemon:iapapa_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=-2073,y=104,z=-364,distance=..5,tag=ItemLoot194] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-2073,y=104,z=-364,distance=..5,tag=!ItemLoot194] run givetm thunderwave  @s
execute as @s[x=-2073,y=104,z=-364,distance=..5,tag=!ItemLoot194] run tellraw @s {"text":"You found the TM Thunder Wave!","italic":true,"color":"gray"}
execute as @s[x=-2073,y=104,z=-364,distance=..5,tag=!ItemLoot194] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-2073,y=104,z=-364,distance=..5,tag=!ItemLoot194] run tag @s add ItemLoot194
...
execute as @s[x=-2163,y=104,z=-345,distance=..5,tag=!ItemLoot195] run give @s mega_showdown:mind_plate
...
execute as @s[x=-2253,y=79,z=-637,distance=..5,tag=ItemLoot200] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-2253,y=79,z=-637,distance=..5,tag=!ItemLoot200] run givetm payback  @s
execute as @s[x=-2253,y=79,z=-637,distance=..5,tag=!ItemLoot200] run tellraw @s {"text":"You received the TM Payback!","italic":true,"color":"gray"}
execute as @s[x=-2253,y=79,z=-637,distance=..5,tag=!ItemLoot200] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-2253,y=79,z=-637,distance=..5,tag=!ItemLoot200] run tag @s add ItemLoot200
...
execute as @s[x=-1218,y=109,z=2104,distance=..5,tag=ItemLoot201] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1218,y=109,z=2104,distance=..5,tag=!ItemLoot201] run give @s cobblemon:soft_sand
execute as @s[x=-1218,y=109,z=2104,distance=..5,tag=!ItemLoot201] run tellraw @s {"text":"You found a Soft Sand!","italic":true,"color":"gray"}
execute as @s[x=-1218,y=109,z=2104,distance=..5,tag=!ItemLoot201] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1218,y=109,z=2104,distance=..5,tag=!ItemLoot201] run tag @s add ItemLoot201
...
execute as @s[x=-2032,y=104,z=-667,distance=..5,tag=!ItemLoot205] run give @s cobblemon:sitrus_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=-2036,y=104,z=-708,distance=..5,tag=ItemLoot207] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-2036,y=104,z=-708,distance=..5,tag=!ItemLoot207] run givetm rockpolish  @s
execute as @s[x=-2036,y=104,z=-708,distance=..5,tag=!ItemLoot207] run tellraw @s {"text":"You found the TM Rock Polish!","italic":true,"color":"gray"}
execute as @s[x=-2036,y=104,z=-708,distance=..5,tag=!ItemLoot207] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-2036,y=104,z=-708,distance=..5,tag=!ItemLoot207] run tag @s add ItemLoot207
...
execute as @s[x=-1574,y=35,z=-204,distance=..5,tag=!ItemLoot215] run tellraw @s {"text":"You received TM70: Flash!","italic":true,"color":"gray"}
...
execute as @s[x=-1641,y=17,z=-377,distance=..5,tag=!ItemLoot220] run give @s mega_showdown:earth_plate
...
execute as @s[x=-1706,y=2,z=-366,distance=..5,tag=ItemLoot221] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1706,y=2,z=-366,distance=..5,tag=!ItemLoot221] run givetm gyroball  @s
execute as @s[x=-1706,y=2,z=-366,distance=..5,tag=!ItemLoot221] run tellraw @s {"text":"You found the TM Gyro Ball!","italic":true,"color":"gray"}
execute as @s[x=-1706,y=2,z=-366,distance=..5,tag=!ItemLoot221] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1706,y=2,z=-366,distance=..5,tag=!ItemLoot221] run tag @s add ItemLoot221
...
execute as @s[x=-1695,y=76,z=-942,distance=..5,tag=!ItemLoot223] run tellraw @s {"text":"You received $1,500!","italic":true,"color":"gray"}
...
execute as @s[x=-1517,y=80,z=-805,distance=..5,tag=!Surf] run tellraw @s {"text":"You received HM03: Surf! You can now travel across water.","italic":true,"color":"gray"}
execute as @s[x=-1517,y=80,z=-805,distance=..5,tag=!Surf] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1517,y=80,z=-805,distance=..5,tag=!Surf] run givetm surf @s
execute as @s[x=-1517,y=80,z=-805,distance=..5,tag=!Surf] run tag @s add Surf

execute as @s[x=-1788,y=84,z=-886,distance=..5,tag=ItemLoot228] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1788,y=84,z=-886,distance=..5,tag=!ItemLoot228] run give @s cobblemon:x_special_attack
execute as @s[x=-1788,y=84,z=-886,distance=..5,tag=!ItemLoot228] run tellraw @s {"text":"You found an X Special Attack!","italic":true,"color":"gray"}
execute as @s[x=-1788,y=84,z=-886,distance=..5,tag=!ItemLoot228] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1788,y=84,z=-886,distance=..5,tag=!ItemLoot228] run tag @s add ItemLoot228
...
execute as @s[x=-1731,y=108,z=-897,distance=..5,tag=!ItemLoot229] run give @s cobblemon:leppa_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=-1662,y=129,z=-1227,distance=..5,tag=ItemLoot232] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1662,y=129,z=-1227,distance=..5,tag=!ItemLoot232] run givetm lowsweep  @s
execute as @s[x=-1662,y=129,z=-1227,distance=..5,tag=!ItemLoot232] run tellraw @s {"text":"You found the TM Low Sweep!","italic":true,"color":"gray"}
execute as @s[x=-1662,y=129,z=-1227,distance=..5,tag=!ItemLoot232] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1662,y=129,z=-1227,distance=..5,tag=!ItemLoot232] run tag @s add ItemLoot232

execute as @s[x=-1427,y=80,z=-849,distance=..5,tag=ItemLoot235] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1427,y=80,z=-849,distance=..5,tag=!ItemLoot235] run function kalos:spawn/honey
execute as @s[x=-1427,y=80,z=-849,distance=..5,tag=!ItemLoot235] run tellraw @s {"text":"You found some Honey!","italic":true,"color":"gray"}
execute as @s[x=-1427,y=80,z=-849,distance=..5,tag=!ItemLoot235] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1427,y=80,z=-849,distance=..5,tag=!ItemLoot235] run tag @s add ItemLoot235
...
execute as @s[x=-1433,y=104,z=-783,distance=..5,tag=!ItemLoot236] run give @s cobblemon:aspear_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=-1386,y=76,z=-749,distance=..5,tag=ItemLoot237] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1386,y=76,z=-749,distance=..5,tag=!ItemLoot237] run give @s cobblemon:net_ball
execute as @s[x=-1386,y=76,z=-749,distance=..5,tag=!ItemLoot237] run tellraw @s {"text":"You found a Net Ball!","italic":true,"color":"gray"}
execute as @s[x=-1386,y=76,z=-749,distance=..5,tag=!ItemLoot237] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1386,y=76,z=-749,distance=..5,tag=!ItemLoot237] run tag @s add ItemLoot237

execute as @s[x=-1391,y=80,z=-850,distance=..5,tag=ItemLoot238] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1391,y=80,z=-850,distance=..5,tag=!ItemLoot238] run givetm attract  @s
execute as @s[x=-1391,y=80,z=-850,distance=..5,tag=!ItemLoot238] run tellraw @s {"text":"You received the TM Attract!","italic":true,"color":"gray"}
execute as @s[x=-1391,y=80,z=-850,distance=..5,tag=!ItemLoot238] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1391,y=80,z=-850,distance=..5,tag=!ItemLoot238] run tag @s add ItemLoot238

execute as @s[x=-1373,y=78,z=-855,distance=..5,tag=ItemLoot239] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1373,y=78,z=-855,distance=..5,tag=!ItemLoot239] run give @s cobblemon:sachet
execute as @s[x=-1373,y=78,z=-855,distance=..5,tag=!ItemLoot239] run tellraw @s {"text":"You found a Sachet!","italic":true,"color":"gray"}
execute as @s[x=-1373,y=78,z=-855,distance=..5,tag=!ItemLoot239] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1373,y=78,z=-855,distance=..5,tag=!ItemLoot239] run tag @s add ItemLoot239

execute as @s[x=-1274,y=82,z=-884,distance=..5,tag=ItemLoot240] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1274,y=82,z=-884,distance=..5,tag=!ItemLoot240] run give @s cobblemon:shiny_stone
execute as @s[x=-1274,y=82,z=-884,distance=..5,tag=!ItemLoot240] run tellraw @s {"text":"You found a Shiny Stone!","italic":true,"color":"gray"}
execute as @s[x=-1274,y=82,z=-884,distance=..5,tag=!ItemLoot240] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1274,y=82,z=-884,distance=..5,tag=!ItemLoot240] run tag @s add ItemLoot240

execute as @s[x=-1339,y=80,z=-795,distance=..5,tag=ItemLoot241] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1339,y=80,z=-795,distance=..5,tag=!ItemLoot241] run give @s cobblemon:whipped_dream
execute as @s[x=-1339,y=80,z=-795,distance=..5,tag=!ItemLoot241] run tellraw @s {"text":"You found a Whipped Dream!","italic":true,"color":"gray"}
execute as @s[x=-1339,y=80,z=-795,distance=..5,tag=!ItemLoot241] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1339,y=80,z=-795,distance=..5,tag=!ItemLoot241] run tag @s add ItemLoot241

execute as @s[x=-1381,y=80,z=-748,distance=..5,tag=ItemLoot242] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1381,y=80,z=-748,distance=..5,tag=!ItemLoot242] run give @s cobblemon:leftovers
execute as @s[x=-1381,y=80,z=-748,distance=..5,tag=!ItemLoot242] run tellraw @s {"text":"You found Leftovers!","italic":true,"color":"gray"}
execute as @s[x=-1381,y=80,z=-748,distance=..5,tag=!ItemLoot242] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1381,y=80,z=-748,distance=..5,tag=!ItemLoot242] run tag @s add ItemLoot242
...
execute as @s[x=-1286,y=76,z=-1091,distance=..5,tag=!ItemLoot247] run tellraw @s {"text":"You received $4,000!","italic":true,"color":"gray"}
...
execute as @s[x=-1251,y=76,z=-1127,distance=..5,tag=!ItemLoot248] run tellraw @s {"text":"You received $6,000!","italic":true,"color":"gray"}
...
execute as @s[x=-1311,y=76,z=-1210,distance=..5,tag=!ItemLoot249] run give @s mega_showdown:splash_plate
...
execute as @s[x=-1413,y=76,z=-977,distance=..5,tag=ItemLoot255] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1413,y=76,z=-977,distance=..5,tag=!ItemLoot255] run givetm xscissor  @s
execute as @s[x=-1413,y=76,z=-977,distance=..5,tag=!ItemLoot255] run tellraw @s {"text":"You found the TM X-Scissor!","italic":true,"color":"gray"}
execute as @s[x=-1413,y=76,z=-977,distance=..5,tag=!ItemLoot255] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1413,y=76,z=-977,distance=..5,tag=!ItemLoot255] run tag @s add ItemLoot255

execute as @s[x=-1196,y=81,z=-812,distance=..5,tag=ItemLoot256] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1196,y=81,z=-812,distance=..5,tag=!ItemLoot256] run give @s cobblemon:elixir
execute as @s[x=-1196,y=81,z=-812,distance=..5,tag=!ItemLoot256] run tellraw @s {"text":"You found an Elixir!","italic":true,"color":"gray"}
execute as @s[x=-1196,y=81,z=-812,distance=..5,tag=!ItemLoot256] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1196,y=81,z=-812,distance=..5,tag=!ItemLoot256] run tag @s add ItemLoot256
...
execute as @s[x=-1134,y=81,z=-817,distance=..5,tag=!ItemLoot257] run tellraw @s {"text":"You received a Silk Scarf!","italic":true,"color":"gray"}
...
execute as @s[x=-1141,y=80,z=-772,distance=..5,tag=ItemLoot259] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1141,y=80,z=-772,distance=..5,tag=!ItemLoot259] run give @s cobblemon:awakening
execute as @s[x=-1141,y=80,z=-772,distance=..5,tag=!ItemLoot259] run tellraw @s {"text":"You found an Awakening!","italic":true,"color":"gray"}
execute as @s[x=-1141,y=80,z=-772,distance=..5,tag=!ItemLoot259] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1141,y=80,z=-772,distance=..5,tag=!ItemLoot259] run tag @s add ItemLoot259
...
execute as @s[x=-1094,y=80,z=-785,distance=..5,tag=!ItemLoot260] run tellraw @s {"text":"You received a Good Rod!","italic":true,"color":"gray"}
...
execute as @s[x=-1049,y=80,z=-790,distance=..5,tag=!ItemLoot263] run tellraw @s {"text":"You received HM02: Fly!","italic":true,"color":"gray"}
...
execute as @s[x=-987,y=115,z=-672,distance=..5,tag=ItemLoot265] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-987,y=115,z=-672,distance=..5,tag=!ItemLoot265] run give @s cobblemon:metronome
execute as @s[x=-987,y=115,z=-672,distance=..5,tag=!ItemLoot265] run tellraw @s {"text":"You received a Metronome!","italic":true,"color":"gray"}
execute as @s[x=-987,y=115,z=-672,distance=..5,tag=!ItemLoot265] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-987,y=115,z=-672,distance=..5,tag=!ItemLoot265] run tag @s add ItemLoot265
...
execute as @s[x=-1042,y=119,z=-731,distance=..5,tag=!ItemLoot268] run give @s mega_showdown:sky_plate
...
execute as @s[x=-754,y=104,z=-674,distance=..5,tag=!ItemLoot276] run give @s mega_showdown:flame_plate
...
execute as @s[x=-785,y=104,z=-574,distance=..5,tag=!ItemLoot278] run tellraw @s {"text":"You received $6,000!","italic":true,"color":"gray"}
...
execute as @s[x=-836,y=104,z=-378,distance=..5,tag=ItemLoot282] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-836,y=104,z=-378,distance=..5,tag=!ItemLoot282] run givetm chargebeam  @s
execute as @s[x=-836,y=104,z=-378,distance=..5,tag=!ItemLoot282] run tellraw @s {"text":"You found the TM Charge Beam!","italic":true,"color":"gray"}
execute as @s[x=-836,y=104,z=-378,distance=..5,tag=!ItemLoot282] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-836,y=104,z=-378,distance=..5,tag=!ItemLoot282] run tag @s add ItemLoot282
...
execute as @s[x=-733,y=104,z=-443,distance=..5,tag=!ItemLoot285] run tellraw @s {"text":"You received $1,500!","italic":true,"color":"gray"}
...
execute as @s[x=-962,y=48,z=-383,distance=..5,tag=!ItemLoot287] run give @s mega_showdown:zap_plate
...
execute as @s[x=-951,y=63,z=-361,distance=..5,tag=ItemLoot289] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-951,y=63,z=-361,distance=..5,tag=!ItemLoot289] run givetm flamecharge  @s
execute as @s[x=-951,y=63,z=-361,distance=..5,tag=!ItemLoot289] run tellraw @s {"text":"You received the TM Flame Charge!","italic":true,"color":"gray"}
execute as @s[x=-951,y=63,z=-361,distance=..5,tag=!ItemLoot289] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-951,y=63,z=-361,distance=..5,tag=!ItemLoot289] run tag @s add ItemLoot289

execute as @s[x=-957,y=63,z=-361,distance=..5,tag=ItemLoot290] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-957,y=63,z=-361,distance=..5,tag=!ItemLoot290] run give @s cobblemon:magnet
execute as @s[x=-957,y=63,z=-361,distance=..5,tag=!ItemLoot290] run tellraw @s {"text":"You received a Magnet!","italic":true,"color":"gray"}
execute as @s[x=-957,y=63,z=-361,distance=..5,tag=!ItemLoot290] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-957,y=63,z=-361,distance=..5,tag=!ItemLoot290] run tag @s add ItemLoot290
...
execute as @s[x=-171,y=100,z=-1044,distance=..5,tag=!ItemLoot294] run tellraw @s {"text":"You received $250!","italic":true,"color":"gray"}
...
execute as @s[x=-238,y=100,z=-1045,distance=..5,tag=!ItemLoot296] run tellraw @s {"text":"You received $2,500!","italic":true,"color":"gray"}
...
execute as @s[x=-161,y=99,z=-1220,distance=..5,tag=ItemLoot298] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-161,y=99,z=-1220,distance=..5,tag=!ItemLoot298] run givetm toxic  @s
execute as @s[x=-161,y=99,z=-1220,distance=..5,tag=!ItemLoot298] run tellraw @s {"text":"You received the TM Toxic!","italic":true,"color":"gray"}
execute as @s[x=-161,y=99,z=-1220,distance=..5,tag=!ItemLoot298] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-161,y=99,z=-1220,distance=..5,tag=!ItemLoot298] run tag @s add ItemLoot298
...
execute as @s[x=-57,y=100,z=-1202,distance=..5,tag=!ItemLoot302] run give @s cobblemon:roseli_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=-197,y=100,z=-1361,distance=..5,tag=ItemLoot305] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-197,y=100,z=-1361,distance=..5,tag=!ItemLoot305] run givetm torment  @s
execute as @s[x=-197,y=100,z=-1361,distance=..5,tag=!ItemLoot305] run tellraw @s {"text":"You received the TM Torment!","italic":true,"color":"gray"}
execute as @s[x=-197,y=100,z=-1361,distance=..5,tag=!ItemLoot305] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-197,y=100,z=-1361,distance=..5,tag=!ItemLoot305] run tag @s add ItemLoot305
...
execute as @s[x=389,y=108,z=-581,distance=..5,tag=!ItemLoot326] run give @s cobblemon:leppa_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=419,y=108,z=-559,distance=..5,tag=!ItemLoot329] run tellraw @s {"text":"You received $250!","italic":true,"color":"gray"}
...
execute as @s[x=526,y=112,z=-552,distance=..5,tag=!ItemLoot334] run give @s mega_showdown:stone_plate
...
execute as @s[x=491,y=108,z=-415,distance=..5,tag=!ItemLoot336] run tellraw @s {"text":"You received $500!","italic":true,"color":"gray"}
...
execute as @s[x=455,y=108,z=-431,distance=..5,tag=ItemLoot338] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=455,y=108,z=-431,distance=..5,tag=!ItemLoot338] run givetm darkpulse  @s
execute as @s[x=455,y=108,z=-431,distance=..5,tag=!ItemLoot338] run tellraw @s {"text":"You found the TM Dark Pulse!","italic":true,"color":"gray"}
execute as @s[x=455,y=108,z=-431,distance=..5,tag=!ItemLoot338] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=455,y=108,z=-431,distance=..5,tag=!ItemLoot338] run tag @s add ItemLoot338
...
execute as @s[x=489,y=92,z=-486,distance=..5,tag=ItemLoot341] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=489,y=92,z=-486,distance=..5,tag=!ItemLoot341] run givetm snarl  @s
execute as @s[x=489,y=92,z=-486,distance=..5,tag=!ItemLoot341] run tellraw @s {"text":"You found the TM Snarl!","italic":true,"color":"gray"}
execute as @s[x=489,y=92,z=-486,distance=..5,tag=!ItemLoot341] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=489,y=92,z=-486,distance=..5,tag=!ItemLoot341] run tag @s add ItemLoot341
...
execute as @s[x=484,y=92,z=-393,distance=..5,tag=!ItemLoot342] run give @s mega_showdown:dread_plate
...
execute as @s[x=431,y=92,z=-378,distance=..5,tag=ItemLoot343] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=431,y=92,z=-378,distance=..5,tag=!ItemLoot343] run givetm fling  @s
execute as @s[x=431,y=92,z=-378,distance=..5,tag=!ItemLoot343] run tellraw @s {"text":"You received the TM Fling!","italic":true,"color":"gray"}
execute as @s[x=431,y=92,z=-378,distance=..5,tag=!ItemLoot343] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=431,y=92,z=-378,distance=..5,tag=!ItemLoot343] run tag @s add ItemLoot343
...
execute as @s[x=471,y=108,z=-210,distance=..5,tag=!ItemLoot348] run give @s cobblemon:lum_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=461,y=108,z=-186,distance=..5,tag=!ItemLoot349] run tellraw @s {"text":"You received $2,500!","italic":true,"color":"gray"}
...
execute as @s[x=337,y=81,z=-262,distance=..5,tag=!ItemLoot351] run tellraw @s {"text":"You received a Super Rod!","italic":true,"color":"gray"}
...
execute as @s[x=377,y=104,z=-200,distance=..5,tag=!ItemLoot354] run give @s mega_showdown:fist_plate
...
execute as @s[x=632,y=87,z=-386,distance=..5,tag=!ItemLoot356] run give @s cobblemon:sitrus_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=691,y=108,z=-338,distance=..5,tag=!ItemLoot359] run tellraw @s {"text":"You received $5,000!","italic":true,"color":"gray"}
...
execute as @s[x=606,y=87,z=-549,distance=..5,tag=ItemLoot361] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=606,y=87,z=-549,distance=..5,tag=!ItemLoot361] run scoreboard players add @s Money 20000
execute as @s[x=606,y=87,z=-549,distance=..5,tag=!ItemLoot361] run tellraw @s {"text":"You received $20,000!","italic":true,"color":"gray"}
execute as @s[x=606,y=87,z=-549,distance=..5,tag=!ItemLoot361] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=606,y=87,z=-549,distance=..5,tag=!ItemLoot361] run tag @s add ItemLoot361
...
execute as @s[x=856,y=109,z=-619,distance=..5,tag=ItemLoot368] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=856,y=109,z=-619,distance=..5,tag=!ItemLoot368] run givetm stoneedge  @s
execute as @s[x=856,y=109,z=-619,distance=..5,tag=!ItemLoot368] run tellraw @s {"text":"You found the TM Stone Edge!","italic":true,"color":"gray"}
execute as @s[x=856,y=109,z=-619,distance=..5,tag=!ItemLoot368] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=856,y=109,z=-619,distance=..5,tag=!ItemLoot368] run tag @s add ItemLoot368
...
execute as @s[x=608,y=65,z=-1087,distance=..5,tag=!ItemLoot376] run tellraw @s {"text":"You received $1,000!","italic":true,"color":"gray"}
...
execute as @s[x=822,y=85,z=-1028,distance=..5,tag=ItemLoot380] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=822,y=85,z=-1028,distance=..5,tag=!ItemLoot380] run givetm frostbreath  @s
execute as @s[x=822,y=85,z=-1028,distance=..5,tag=!ItemLoot380] run tellraw @s {"text":"You found the TM Frost Breath!","italic":true,"color":"gray"}
execute as @s[x=822,y=85,z=-1028,distance=..5,tag=!ItemLoot380] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=822,y=85,z=-1028,distance=..5,tag=!ItemLoot380] run tag @s add ItemLoot380
...
execute as @s[x=921,y=108,z=-399,distance=..5,tag=!ItemLoot386] run give @s mega_showdown:icicle_plate
...
execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=1..2}] as @s[x=1282,y=80,z=-209,distance=..5,tag=ItemLoot392] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=1..2}] as @s[x=1282,y=80,z=-209,distance=..5,tag=!ItemLoot392] run givetm flamethrower  @s
execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=1..2}] as @s[x=1282,y=80,z=-209,distance=..5,tag=!ItemLoot392] run tellraw @s {"text":"You received the TM Flamethrower!","italic":true,"color":"gray"}
execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=1..2}] as @s[x=1282,y=80,z=-209,distance=..5,tag=!ItemLoot392] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=1..2}] as @s[x=1282,y=80,z=-209,distance=..5,tag=!ItemLoot392] run tag @s add ItemLoot392

execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=3}] as @s[x=1282,y=80,z=-209,distance=..5,tag=ItemLoot393] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=3}] as @s[x=1282,y=80,z=-209,distance=..5,tag=!ItemLoot393] run givetm psychup  @s
execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=3}] as @s[x=1282,y=80,z=-209,distance=..5,tag=!ItemLoot393] run tellraw @s {"text":"You received the TM Psych Up!","italic":true,"color":"gray"}
execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=3}] as @s[x=1282,y=80,z=-209,distance=..5,tag=!ItemLoot393] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=3}] as @s[x=1282,y=80,z=-209,distance=..5,tag=!ItemLoot393] run tag @s add ItemLoot393

execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=4..5}] as @s[x=1282,y=80,z=-209,distance=..5,tag=ItemLoot394] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=4..5}] as @s[x=1282,y=80,z=-209,distance=..5,tag=!ItemLoot394] run givetm substitute  @s
execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=4..5}] as @s[x=1282,y=80,z=-209,distance=..5,tag=!ItemLoot394] run tellraw @s {"text":"You received the TM Substitute!","italic":true,"color":"gray"}
execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=4..5}] as @s[x=1282,y=80,z=-209,distance=..5,tag=!ItemLoot394] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=4..5}] as @s[x=1282,y=80,z=-209,distance=..5,tag=!ItemLoot394] run tag @s add ItemLoot394

execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=6..}] as @s[x=1282,y=80,z=-209,distance=..5,tag=ItemLoot395] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=6..}] as @s[x=1282,y=80,z=-209,distance=..5,tag=!ItemLoot395] run givetm doubleteam  @s
execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=6..}] as @s[x=1282,y=80,z=-209,distance=..5,tag=!ItemLoot395] run tellraw @s {"text":"You received the TM Double Team!","italic":true,"color":"gray"}
execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=6..}] as @s[x=1282,y=80,z=-209,distance=..5,tag=!ItemLoot395] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute if entity @e[x=-687,y=100,z=1388,dy=4,type=armor_stand,scores={Weekday=6..}] as @s[x=1282,y=80,z=-209,distance=..5,tag=!ItemLoot395] run tag @s add ItemLoot395
...
execute as @s[x=1230,y=108,z=-300,distance=..5,tag=!ItemLoot399] run tellraw @s {"text":"You received $500!","italic":true,"color":"gray"}
...
execute as @s[x=1337,y=80,z=-209,distance=..5,tag=ItemLoot401] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1337,y=80,z=-209,distance=..5,tag=!ItemLoot401] run givetm hiddenpower  @s
execute as @s[x=1337,y=80,z=-209,distance=..5,tag=!ItemLoot401] run tellraw @s {"text":"You received the TM Hidden Power!","italic":true,"color":"gray"}
execute as @s[x=1337,y=80,z=-209,distance=..5,tag=!ItemLoot401] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1337,y=80,z=-209,distance=..5,tag=!ItemLoot401] run tag @s add ItemLoot401
...
execute as @s[x=1409,y=108,z=-100,distance=..5,tag=!ItemLoot404] run give @s cobblemon:wacan_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=1623,y=70,z=42,distance=..5,tag=ItemLoot413] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1623,y=70,z=42,distance=..5,tag=!ItemLoot413] run givetm brickbreak  @s
execute as @s[x=1623,y=70,z=42,distance=..5,tag=!ItemLoot413] run tellraw @s {"text":"You found the TM Brick Break!","italic":true,"color":"gray"}
execute as @s[x=1623,y=70,z=42,distance=..5,tag=!ItemLoot413] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1623,y=70,z=42,distance=..5,tag=!ItemLoot413] run tag @s add ItemLoot413
...
execute as @s[x=1933,y=53,z=-23,distance=..5,tag=!ItemLoot414] run tellraw @s {"text":"You received $6,000!","italic":true,"color":"gray"}
...
execute as @s[x=1965,y=4,z=-110,distance=..5,tag=ItemLoot425] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1965,y=4,z=-110,distance=..5,tag=!ItemLoot425] run givetm shadowball  @s
execute as @s[x=1965,y=4,z=-110,distance=..5,tag=!ItemLoot425] run tellraw @s {"text":"You found the TM Shadow Ball!","italic":true,"color":"gray"}
execute as @s[x=1965,y=4,z=-110,distance=..5,tag=!ItemLoot425] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1965,y=4,z=-110,distance=..5,tag=!ItemLoot425] run tag @s add ItemLoot425
...
execute as @s[x=1961,y=10,z=-43,distance=..5,tag=!ItemLoot428] run give @s mega_showdown:iron_plate
...
execute as @s[x=2055,y=56,z=-203,distance=..5,tag=!ItemLoot434] run tellraw @s {"text":"You received $20,000!","italic":true,"color":"gray"}
...
execute as @s[x=1465,y=100,z=141,distance=..5,tag=!ItemLoot435] run tellraw @s {"text":"You received $500!","italic":true,"color":"gray"}
...
execute as @s[x=1536,y=120,z=161,distance=..5,tag=ItemLoot437] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1536,y=120,z=161,distance=..5,tag=!ItemLoot437] run givetm uturn  @s
execute as @s[x=1536,y=120,z=161,distance=..5,tag=!ItemLoot437] run tellraw @s {"text":"You received the TM U-turn!","italic":true,"color":"gray"}
execute as @s[x=1536,y=120,z=161,distance=..5,tag=!ItemLoot437] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1536,y=120,z=161,distance=..5,tag=!ItemLoot437] run tag @s add ItemLoot437
...
execute as @s[x=1481,y=81,z=274,distance=..5,tag=!ItemLoot442,scores={StarterPick=1}] run tellraw @s {"text":"You received a Miracle Seed!","italic":true,"color":"gray"}
execute as @s[x=1481,y=81,z=274,distance=..5,tag=!ItemLoot442,scores={StarterPick=2}] run tellraw @s {"text":"You received a Charcoal!","italic":true,"color":"gray"}
execute as @s[x=1481,y=81,z=274,distance=..5,tag=!ItemLoot442,scores={StarterPick=3}] run tellraw @s {"text":"You received a Mystic Water!","italic":true,"color":"gray"}
...
execute as @s[x=1593,y=65,z=265,distance=..5,tag=ItemLoot443] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1593,y=65,z=265,distance=..5,tag=!ItemLoot443] run givetm scald  @s
execute as @s[x=1593,y=65,z=265,distance=..5,tag=!ItemLoot443] run tellraw @s {"text":"You received the TM Scald!","italic":true,"color":"gray"}
execute as @s[x=1593,y=65,z=265,distance=..5,tag=!ItemLoot443] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1593,y=65,z=265,distance=..5,tag=!ItemLoot443] run tag @s add ItemLoot443
...
execute as @s[x=1619,y=125,z=298,distance=..5,tag=ItemLoot448] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1619,y=125,z=298,distance=..5,tag=!ItemLoot448] run givetm rockslide  @s
execute as @s[x=1619,y=125,z=298,distance=..5,tag=!ItemLoot448] run tellraw @s {"text":"You found the TM Rock Slide!","italic":true,"color":"gray"}
execute as @s[x=1619,y=125,z=298,distance=..5,tag=!ItemLoot448] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1619,y=125,z=298,distance=..5,tag=!ItemLoot448] run tag @s add ItemLoot448
...
execute as @s[x=1411,y=75,z=561,distance=..5,tag=!ItemLoot452] run tellraw @s {"text":"You received $2,500!","italic":true,"color":"gray"}
...
execute as @s[x=1441,y=75,z=351,distance=..5,tag=!ItemLoot454] run give @s mega_showdown:toxic_plate
...
execute as @s[x=1448,y=87,z=396,distance=..5,tag=!ItemLoot456] run give @s cobblemon:yache_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=1480,y=100,z=408,distance=..5,tag=ItemLoot457] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1480,y=100,z=408,distance=..5,tag=!ItemLoot457] run givetm sludgebomb  @s
execute as @s[x=1480,y=100,z=408,distance=..5,tag=!ItemLoot457] run tellraw @s {"text":"You found the TM Sludge Bomb!","italic":true,"color":"gray"}
execute as @s[x=1480,y=100,z=408,distance=..5,tag=!ItemLoot457] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1480,y=100,z=408,distance=..5,tag=!ItemLoot457] run tag @s add ItemLoot457
...
execute as @s[x=1196,y=50,z=432,distance=..5,tag=ItemLoot463] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1196,y=50,z=432,distance=..5,tag=!ItemLoot463] run givetm bulkup  @s
execute as @s[x=1196,y=50,z=432,distance=..5,tag=!ItemLoot463] run tellraw @s {"text":"You received the TM Bulk Up!","italic":true,"color":"gray"}
execute as @s[x=1196,y=50,z=432,distance=..5,tag=!ItemLoot463] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1196,y=50,z=432,distance=..5,tag=!ItemLoot463] run tag @s add ItemLoot463
...
execute as @s[x=1381,y=100,z=782,distance=..5,tag=!ItemLoot469] run give @s cobblemon:kasib_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=1384,y=100,z=960,distance=..5,tag=!ItemLoot471] run give @s mega_showdown:meadow_plate
...
execute as @s[x=1159,y=100,z=897,distance=..5,tag=ItemLoot476] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1159,y=100,z=897,distance=..5,tag=!ItemLoot476] run scoreboard players add @s Money 250
execute as @s[x=1159,y=100,z=897,distance=..5,tag=!ItemLoot476] run tellraw @s {"text":"You received $250!","italic":true,"color":"gray"}
execute as @s[x=1159,y=100,z=897,distance=..5,tag=!ItemLoot476] run playsound itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1159,y=100,z=897,distance=..5,tag=!ItemLoot476] run tag @s add ItemLoot476
...
execute as @s[x=1086,y=106,z=974,distance=..5,tag=!ItemLoot477] run tellraw @s {"text":"You received $7,500!","italic":true,"color":"gray"}
...
execute as @s[x=1417,y=100,z=992,distance=..5,tag=ItemLoot479] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1417,y=100,z=992,distance=..5,tag=!ItemLoot479] run givetm energyball  @s
execute as @s[x=1417,y=100,z=992,distance=..5,tag=!ItemLoot479] run tellraw @s {"text":"You found the TM Energy Ball!","italic":true,"color":"gray"}
execute as @s[x=1417,y=100,z=992,distance=..5,tag=!ItemLoot479] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1417,y=100,z=992,distance=..5,tag=!ItemLoot479] run tag @s add ItemLoot479
...
execute as @s[x=867,y=93,z=715,distance=..5,tag=!ItemLoot482] run tellraw @s {"text":"You received $500!","italic":true,"color":"gray"}
...
execute as @s[x=740,y=95,z=657,distance=..5,tag=!ItemLoot487] run give @s mega_showdown:pixie_plate
...
execute as @s[x=721,y=100,z=612,distance=..5,tag=ItemLoot488] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=721,y=100,z=612,distance=..5,tag=!ItemLoot488] run givetm psychic  @s
execute as @s[x=721,y=100,z=612,distance=..5,tag=!ItemLoot488] run tellraw @s {"text":"You found the TM Psychic!","italic":true,"color":"gray"}
execute as @s[x=721,y=100,z=612,distance=..5,tag=!ItemLoot488] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=721,y=100,z=612,distance=..5,tag=!ItemLoot488] run tag @s add ItemLoot488
...
execute as @s[x=941,y=100,z=389,distance=..5,tag=!ItemLoot490] run give @s mega_showdown:insect_plate
...
execute as @s[x=822,y=100,z=499,distance=..5,tag=ItemLoot496] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=822,y=100,z=499,distance=..5,tag=!ItemLoot496] run givetm solarbeam  @s
execute as @s[x=822,y=100,z=499,distance=..5,tag=!ItemLoot496] run tellraw @s {"text":"You found the TM Solar Beam!","italic":true,"color":"gray"}
execute as @s[x=822,y=100,z=499,distance=..5,tag=!ItemLoot496] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=822,y=100,z=499,distance=..5,tag=!ItemLoot496] run tag @s add ItemLoot496
...
execute as @s[x=880,y=104,z=316,distance=..5,tag=!ItemLoot497] run tellraw @s {"text":"You received $10,000!","italic":true,"color":"gray"}
...
execute as @s[x=794,y=104,z=299,distance=..5,tag=!ItemLoot499] run give @s cobblemon:figy_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=653,y=100,z=485,distance=..5,tag=!ItemLoot502] run give @s mega_showdown:draco_plate
...
execute as @s[x=625,y=91,z=572,distance=..5,tag=!ItemLoot504] run give @s cobblemon:tanga_berry[can_place_on={predicates:[{blocks:farmland}]}]
...
execute as @s[x=596,y=91,z=542,distance=..5,tag=ItemLoot506] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=596,y=91,z=542,distance=..5,tag=!ItemLoot506] run givetm earthquake  @s
execute as @s[x=596,y=91,z=542,distance=..5,tag=!ItemLoot506] run tellraw @s {"text":"You found the TM Earthquake!","italic":true,"color":"gray"}
execute as @s[x=596,y=91,z=542,distance=..5,tag=!ItemLoot506] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=596,y=91,z=542,distance=..5,tag=!ItemLoot506] run tag @s add ItemLoot506
...
execute as @s[x=583,y=72,z=425,distance=..5,tag=!ItemLoot507] run give @s mega_showdown:spooky_plate
...
execute as @s[x=2040,y=175,z=2377,distance=..5,tag=ItemLoot516] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=2040,y=175,z=2377,distance=..5,tag=!ItemLoot516] run givetm psyshock  @s
execute as @s[x=2040,y=175,z=2377,distance=..5,tag=!ItemLoot516] run tellraw @s {"text":"You found the TM Psyshock!","italic":true,"color":"gray"}
execute as @s[x=2040,y=175,z=2377,distance=..5,tag=!ItemLoot516] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=2040,y=175,z=2377,distance=..5,tag=!ItemLoot516] run tag @s add ItemLoot516
...
execute as @s[x=2348,y=190,z=2275,distance=..5,tag=!ItemLoot522] run tellraw @s {"text":"You received $500!","italic":true,"color":"gray"}
...
execute as @s[x=1758,y=190,z=2172,distance=..5,tag=ItemLoot529] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1758,y=190,z=2172,distance=..5,tag=!ItemLoot529] run givetm dragonclaw  @s
execute as @s[x=1758,y=190,z=2172,distance=..5,tag=!ItemLoot529] run tellraw @s {"text":"You found the TM Dragon Claw!","italic":true,"color":"gray"}
execute as @s[x=1758,y=190,z=2172,distance=..5,tag=!ItemLoot529] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1758,y=190,z=2172,distance=..5,tag=!ItemLoot529] run tag @s add ItemLoot529
...
execute as @s[x=1599,y=96,z=1413,distance=..5,tag=!ItemLoot531] run tellraw @s {"text":"You received $6,000!","italic":true,"color":"gray"}
...
execute as @s[x=1246,y=80,z=1648,distance=..5,tag=ItemLoot535] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1246,y=80,z=1648,distance=..5,tag=!ItemLoot535] run givetm flashcannon  @s
execute as @s[x=1246,y=80,z=1648,distance=..5,tag=!ItemLoot535] run tellraw @s {"text":"You received the TM Flash Cannon!","italic":true,"color":"gray"}
execute as @s[x=1246,y=80,z=1648,distance=..5,tag=!ItemLoot535] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1246,y=80,z=1648,distance=..5,tag=!ItemLoot535] run tag @s add ItemLoot535
...
execute as @s[x=1304,y=108,z=1586,distance=..5,tag=!ItemLoot536] run tellraw @s {"text":"You received $5,000!","italic":true,"color":"gray"}
...
execute as @s[x=1136,y=91,z=1526,distance=..5,tag=ItemLoot537] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1136,y=91,z=1526,distance=..5,tag=!ItemLoot537] run givetm skydrop  @s
execute as @s[x=1136,y=91,z=1526,distance=..5,tag=!ItemLoot537] run tellraw @s {"text":"You received the TM Sky Drop!","italic":true,"color":"gray"}
execute as @s[x=1136,y=91,z=1526,distance=..5,tag=!ItemLoot537] run playsound tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1136,y=91,z=1526,distance=..5,tag=!ItemLoot537] run tag @s add ItemLoot537
...
execute as @s[x=1173,y=67,z=1527,distance=..5,tag=!ItemLoot538] run tellraw @s {"text":"You received DNA Splicers!","italic":true,"color":"gray"}
...
execute as @s[x=-205,y=104,z=-1486,distance=..5,tag=ItemLoot540] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-205,y=104,z=-1486,distance=..5,tag=!ItemLoot540] run give @s mega_showdown:gengarite
execute as @s[x=-205,y=104,z=-1486,distance=..5,tag=!ItemLoot540] run tellraw @s {"text":"You received a Gengarite!","italic":true,"color":"gray"}
execute as @s[x=-205,y=104,z=-1486,distance=..5,tag=!ItemLoot540] run playsound minecraft:megastoneget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-205,y=104,z=-1486,distance=..5,tag=!ItemLoot540] run tag @s add ItemLoot540

execute as @s[x=-1926,y=141,z=604,distance=..5,tag=ItemLoot541] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1926,y=141,z=604,distance=..5,tag=!ItemLoot541] run give @s mega_showdown:aerodactylite
execute as @s[x=-1926,y=141,z=604,distance=..5,tag=!ItemLoot541] run tellraw @s {"text":"You received an Aerodactylite!","italic":true,"color":"gray"}
execute as @s[x=-1926,y=141,z=604,distance=..5,tag=!ItemLoot541] run playsound minecraft:megastoneget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1926,y=141,z=604,distance=..5,tag=!ItemLoot541] run tag @s add ItemLoot541

execute as @s[x=-1449,y=80,z=-816,distance=..5,tag=ItemLoot542] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1449,y=80,z=-816,distance=..5,tag=!ItemLoot542] run pokegive lapras level=30
execute as @s[x=-1449,y=80,z=-816,distance=..5,tag=!ItemLoot542] run tellraw @s {"text":"You received a Lapras!","italic":true,"color":"gray"}
