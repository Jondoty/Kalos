...
execute as @e[x=-1371,y=20,z=-1267,dx=76,dy=30,dz=107,name=Articuno,type=pixelmon:statue] run tellraw @a[distance=..6,scores={Articuno=6..,StarterPick=1}] {"text":"You already battled Articuno!","italic":true,"color":"gray"}
execute as @e[x=-1371,y=20,z=-1267,dx=76,dy=30,dz=107,name=Zapdos,type=pixelmon:statue] run tellraw @a[distance=..6,scores={Zapdos_min=6..,StarterPick=2}] {"text":"You already battled Zapdos!","italic":true,"color":"gray"}
execute as @e[x=-1371,y=20,z=-1267,dx=76,dy=30,dz=107,name=Moltres,type=pixelmon:statue] run tellraw @a[distance=..6,scores={Moltres_min=6..,StarterPick=3}] {"text":"You already battled Moltres!","italic":true,"color":"gray"}

execute as @e[x=-1371,y=20,z=-1267,dx=76,dy=30,dz=107,name=Articuno,type=pixelmon:statue] run tellraw @p[distance=..6,scores={Articuno=0,StarterPick=2..}] {"text":"You aren't able to battle this Pokemon!","italic":true,"color":"gray"}
execute as @e[x=-1371,y=20,z=-1267,dx=76,dy=30,dz=107,name=Zapdos,type=pixelmon:statue] run tellraw @a[distance=..6,scores={Zapdos=0,StarterPick=1}] {"text":"You aren't able to battle this Pokemon!!","italic":true,"color":"gray"}
execute as @e[x=-1371,y=20,z=-1267,dx=76,dy=30,dz=107,name=Zapdos,type=pixelmon:statue] run tellraw @a[distance=..6,scores={Zapdos=0,StarterPick=3}] {"text":"You aren't able to battle this Pokemon!!","italic":true,"color":"gray"}
execute as @e[x=-1371,y=20,z=-1267,dx=76,dy=30,dz=107,name=Moltres,type=pixelmon:statue] run tellraw @a[distance=..6,scores={Moltres=0,StarterPick=1..2}] {"text":"You aren't able to battle this Pokemon!","italic":true,"color":"gray"}
...
execute as @s[scores={Mewtwo=0},x=845,y=75,z=559,distance=..10] run execute as @e[x=845,y=75,z=559,distance=..5,type=pixelmon:statue] run pokespawn Mewtwo lvl:70 gr:7
execute as @s[scores={Mewtwo=0},x=845,y=75,z=559,distance=..10] run tp @e[x=845,y=75,z=559,distance=..5,type=pixelmon:statue] -501 101 1238
...
#Mewtwo reset
#execute as @e[x=-501,y=101,z=1238,r=2,type=pixelmon:statue] run execute as @s[x=809,y=74,z=525,dx=66,dy=14,dz=92,score_Mewtwo=0] run tp @e[x=-501,y=101,z=1238,r=2,type=pixelmon:statue] 845 75 559



#Zygarde Activate:
execute as @s[scores={Zygarde=0},x=2015,y=61,z=-176,distance=..10] run particle cloud 2015 61 -176 1 1 1 0.15 1000
execute as @s[scores={Zygarde=0},x=2015,y=61,z=-176,distance=..10] run execute as @e[x=2015,y=61,z=-176,distance=..5,type=pixelmon:statue] run pokespawn Zygarde lvl:70 gr:7 f:3
execute as @s[scores={Zygarde=0},x=2015,y=61,z=-176,distance=..10] run tp @e[x=2015,y=61,z=-176,distance=..5,type=pixelmon:statue] -501 109 1238
...
#Zygarde reset
#execute as @e[x=-501,y=110,z=1238,r=2,type=pixelmon:statue] run execute as @s[x=2015,y=61,z=-176,distance=..50,score_Zygarde=0] run tp @e[x=-501,y=110,z=1238,r=2,type=pixelmon:statue] 2015 61 -174
...
execute as @s[scores={Diancie=0},x=-1707,y=2,z=-437,distance=..10] run execute as @e[x=-1707,y=2,z=-437,distance=..5,type=pixelmon:statue] run pokespawn Diancie lvl:50 gr:7
execute as @s[scores={Diancie=0},x=-1707,y=2,z=-437,distance=..10] run tp @e[x=-1707,y=2,z=-437,distance=..5,type=pixelmon:statue] -501 128 1238
...
#Diancie reset
#execute as @e[x=-501,y=128,z=1238,r=2,type=pixelmon:statue] run execute as @s[x=-1707,y=2,z=-437,distance=..50,score_Diancie=0] run tp @e[x=-501,y=128,z=1238,r=2,type=pixelmon:statue] -1707 2 -437
...
execute as @s[scores={Hoopa=0},x=-243,y=84,z=-1255,dx=25,dy=10,dz=33] run execute as @e[x=-230,y=88,z=-1242,dy=3,type=pixelmon:statue] run pokespawn Hoopa lvl:50 gr:7
execute as @s[scores={Hoopa=0},x=-243,y=84,z=-1255,dx=25,dy=10,dz=33] run tp @e[x=-230,y=88,z=-1242,dy=3,type=pixelmon:statue] -501 119 1238
...
execute as @s[x=-1371,y=20,z=-1267,dx=76,dy=30,dz=107,scores={Moltres=5,StarterPick=3}] run execute as @e[x=-1313,y=21,z=-1232,dy=3,type=pixelmon:statue] run pokespawn Moltres lvl:70 gr:7
execute as @s[x=-1371,y=20,z=-1267,dx=76,dy=30,dz=107,scores={Moltres=5,StarterPick=3}] run tp @e[x=-1313,y=21,z=-1232,dy=3,type=pixelmon:statue] -501 155 1238
...
execute as @s[x=-1371,y=20,z=-1267,dx=76,dy=30,dz=107,scores={Zapdos=5,StarterPick=2}] run execute as @e[x=-1349,y=21,z=-1232,dy=3,type=pixelmon:statue] run pokespawn Zapdos lvl:70 gr:7
execute as @s[x=-1371,y=20,z=-1267,dx=76,dy=30,dz=107,scores={Zapdos=5,StarterPick=2}] run tp @e[x=-1349,y=21,z=-1232,dy=3,type=pixelmon:statue] -501 173 1238
...
execute as @s[x=-1371,y=20,z=-1267,dx=76,dy=30,dz=107,scores={Zapdos=5,StarterPick=1}] run execute as @e[x=-1335,y=21,z=-1252,dy=3,type=pixelmon:statue] run pokespawn Articuno lvl:70 gr:7
execute as @s[x=-1371,y=20,z=-1267,dx=76,dy=30,dz=107,scores={Zapdos=5,StarterPick=1}] run tp @e[x=-1335,y=21,z=-1252,dy=3,type=pixelmon:statue] -501 164 1238
...
execute as @s[scores={Volcanion=0},x=-937,y=36,z=-742,dx=280,dy=40,dz=117] run execute as @e[x=-859,y=60,z=-690,dy=3,type=pixelmon:statue] run pokespawn Volcanion lvl:50 gr:7
execute as @s[scores={Volcanion=0},x=-937,y=36,z=-742,dx=280,dy=40,dz=117] run tp @e[x=-859,y=60,z=-690,dy=3,type=pixelmon:statue] -501 137 1238
