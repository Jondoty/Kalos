...
#execute at @e[name=Absolite,type=armor_stand,x=1229,y=119,z=1461,distance=..2] run particle minecraft:dust 3 3 3 1 ~ ~1.25 ~ 1 1 1 0 10 normal @a[scores={Absolite=0},distance=..30]
#execute at @e[name=Absolite,type=armor_stand,x=1229,y=119,z=1461,distance=..2] run give @p[scores={Absolite=0},distance=..2] pixelmon:Absolite 1
...
execute at @e[name=Alakazite,type=armor_stand,x=-1726,y=14,z=-339,distance=..2] run particle minecraft:dust 3 3 3 1 ~ ~1.25 ~ 1 1 1 0 10 normal @a[scores={Alakazite=0},distance=..30]
execute at @e[name=Alakazite,type=armor_stand,x=-1726,y=14,z=-339,distance=..2] run give @p[scores={Alakazite=0},distance=..2] pixelmon:alakazite 1
...
execute at @e[name=Banettite,type=armor_stand,x=581,y=72,z=407,distance=..2] run particle minecraft:dust 3 3 3 1 ~ ~1.25 ~ 1 1 1 0 10 normal @a[scores={Banettite=0},distance=..30]
execute at @e[name=Banettite,type=armor_stand,x=581,y=72,z=407,distance=..2] run give @p[scores={Banettite=0},distance=..2] pixelmon:banettite 1
...
execute at @e[name=Diancite,type=armor_stand,x=-1726,y=14,z=-465,distance=..2] run particle minecraft:dust 3 3 3 1 ~ ~1.25 ~ 1 1 1 0 10 normal @a[scores={Diancite=0},distance=..30]
execute at @e[name=Diancite,type=armor_stand,x=-1726,y=14,z=-465,distance=..2] run give @p[scores={Diancite=0},distance=..2] pixelmon:diancite 1
...
execute at @e[name=Garchompite,type=armor_stand,x=2157,y=175,z=2203,distance=..2] run particle minecraft:dust 3 3 3 1 ~ ~1.25 ~ 1 1 1 0 10 normal @a[scores={Garchompite=0},distance=..30]
execute at @e[name=Garchompite,type=armor_stand,x=2157,y=175,z=2203,distance=..2] run give @p[scores={Garchompite=0},distance=..2] pixelmon:garchompite 1
...
execute at @e[name=Gyaradosite,type=armor_stand,x=1595,y=115,z=235,distance=..2] run particle minecraft:dust 3 3 3 1 ~ ~1.25 ~ 1 1 1 0 10 normal @a[scores={Gyaradosite=0},distance=..30]
execute at @e[name=Gyaradosite,type=armor_stand,x=1595,y=115,z=235,distance=..2] run give @p[scores={Gyaradosite=0},distance=..2] pixelmon:gyaradosite 1
...
execute at @e[name=Heracronite,type=armor_stand,x=455,y=100,z=899,distance=..2] run particle minecraft:dust 3 3 3 1 ~ ~1.25 ~ 1 1 1 0 10 normal @a[scores={Heracronite=0},distance=..30]
execute at @e[name=Heracronite,type=armor_stand,x=455,y=100,z=899,distance=..2] run give @p[scores={Heracronite=0},distance=..2] pixelmon:heracronite 1
...
execute at @e[name=Houndoominite,type=armor_stand,x=526,y=108,z=-251,distance=..2] run particle minecraft:dust 3 3 3 1 ~ ~1.25 ~ 1 1 1 0 10 normal @a[scores={Houndoominite=0},distance=..30]
execute at @e[name=Houndoominite,type=armor_stand,x=526,y=108,z=-251,distance=..2] run give @p[scores={Houndoominite=0},distance=..2] pixelmon:houndoominite 1
...
execute at @e[name=Kangaskhanite,type=armor_stand,x=-1440,y=148,z=485,distance=..2] run particle minecraft:dust 3 3 3 1 ~ ~1.25 ~ 1 1 1 0 10 normal @a[scores={Kangaskhanite=0},distance=..30]
execute at @e[name=Kangaskhanite,type=armor_stand,x=-1440,y=148,z=485,distance=..2] run give @p[scores={Kangaskhanite=0},distance=..2] pixelmon:kangaskhanite 1
...
#Manectite, Route 16
execute at @e[name=Manectite,type=armor_stand,x=489,y=108,z=-251,distance=..2] run particle minecraft:dust 3 3 3 1 ~ ~1.25 ~ 1 1 1 0 10 normal @a[scores={Manectite=0},distance=..30]
execute at @e[name=Manectite,type=armor_stand,x=489,y=108,z=-251,distance=..2] run give @p[scores={Manectite=0},distance=..2] pixelmon:manectite 1
...
execute at @e[name=Mawilite,type=armor_stand,x=-1060,y=69,z=-155,distance=..2] run particle minecraft:dust 3 3 3 1 ~ ~1.25 ~ 1 1 1 0 10 normal @a[scores={Mawilite=0},distance=..30]
execute at @e[name=Mawilite,type=armor_stand,x=-1060,y=69,z=-155,distance=..2] run give @p[scores={Mawilite=0},distance=..2] pixelmon:mawilite 1
...
execute at @e[name=Medichamite,type=armor_stand,x=-126,y=100,z=-1425,distance=..2] run particle minecraft:dust 3 3 3 1 ~ ~1.25 ~ 1 1 1 0 10 normal @a[scores={Medichamite=0},distance=..30]
execute at @e[name=Medichamite,type=armor_stand,x=-126,y=100,z=-1425,distance=..2] run give @p[scores={Medichamite=0},distance=..2] pixelmon:medichamite 1
...
execute at @e[name=Mewtwonite_X,type=armor_stand,x=825,y=75,z=562,distance=..2] run particle minecraft:dust 3 3 3 1 ~ ~1.25 ~ 1 1 1 0 10 normal @a[scores={Mewtwonite_X=0},distance=..30]
execute at @e[name=Mewtwonite_X,type=armor_stand,x=825,y=75,z=562,distance=..2] run give @p[scores={Mewtwonite_X=0},distance=..2] pixelmon:mewtwonite_x 1
...
execute at @e[name=Mewtwonite_Y,type=armor_stand,x=865,y=75,z=562,distance=..2] run particle minecraft:dust 3 3 3 1 ~ ~1.25 ~ 1 1 1 0 10 normal @a[scores={Mewtwonite_Y=0},distance=..30]
execute at @e[name=Mewtwonite_Y,type=armor_stand,x=865,y=75,z=562,distance=..2] run give @p[scores={Mewtwonite_Y=0},distance=..2] pixelmon:mewtwonite_y 1
...
execute at @e[name=Pinsirite,type=armor_stand,x=491,y=100,z=899,distance=..2] run particle minecraft:dust 3 3 3 1 ~ ~1.25 ~ 1 1 1 0 10 normal @a[scores={Pinsirite=0},distance=..30]
execute at @e[name=Pinsirite,type=armor_stand,x=491,y=100,z=899,distance=..2] run give @p[scores={Pinsirite=0},distance=..2] pixelmon:pinsirite 1
...
execute at @e[name=Scizorite,type=armor_stand,x=664,y=85,z=-1371,distance=..2] run particle minecraft:dust 3 3 3 1 ~ ~1.25 ~ 1 1 1 0 10 normal @a[scores={Scizorite=0},distance=..30]
execute at @e[name=Scizorite,type=armor_stand,x=664,y=85,z=-1371,distance=..2] run give @p[scores={Scizorite=0},distance=..2] pixelmon:scizorite 1
...
execute at @e[name=Tyranitarite,type=armor_stand,x=-1660,y=115,z=-1906,distance=..2] run particle minecraft:dust 3 3 3 1 ~ ~1.25 ~ 1 1 1 0 10 normal @a[scores={Tyranitarite=0},distance=..30]
execute at @e[name=Tyranitarite,type=armor_stand,x=-1660,y=115,z=-1906,distance=..2] run give @p[scores={Tyranitarite=0},distance=..2] pixelmon:tyranitarite 1
