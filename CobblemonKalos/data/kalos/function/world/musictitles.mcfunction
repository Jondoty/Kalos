...
execute as @s[x=403,y=0,z=-497,dx=144,dy=100,dz=127] unless entity @s[scores={MusicCheck=31}] run function kalos:triggers/stopsound
...
execute as @s[x=-1092,y=34,z=-401,dx=296,dy=55,dz=122] unless entity @s[scores={MusicCheck=26}] run function kalos:triggers/stopsound
...
execute as @s[x=-937,y=36,z=-742,dx=280,dy=40,dz=117] unless entity @s[scores={MusicCheck=26}] run function kalos:triggers/stopsound
...
execute as @s[x=374,y=0,z=1540,dx=241,dy=256,dz=216] unless entity @s[scores={MusicCheck=1}] run function kalos:triggers/stopsound
...
execute as @s[x=445,y=0,z=1442,dx=62,dy=256,dz=87] unless entity @s[scores={MusicCheck=2}] run function kalos:triggers/stopsound
...
execute as @s[x=395,y=0,z=1236,dx=147,dy=256,dz=205] unless entity @s[scores={MusicCheck=3}] run function kalos:triggers/stopsound
...
execute as @s[x=396,y=0,z=979,dx=146,dy=256,dz=256] unless entity @s[scores={MusicCheck=65}] run function kalos:triggers/stopsound
...
execute as @s[x=93,y=0,z=384,dx=250,dy=256,dz=139] unless entity @s[scores={MusicCheck=4}] run function kalos:triggers/stopsound
...
execute as @s[x=-1146,y=0,z=-213,dx=182,dy=256,dz=337] unless entity @s[scores={MusicCheck=6}] run function kalos:triggers/stopsound
...
execute as @s[x=-2223,y=0,z=-217,dx=354,dy=256,dz=275] unless entity @s[scores={MusicCheck=7}] run function kalos:triggers/stopsound
...
execute as @s[x=-2115,y=0,z=504,dx=240,dy=256,dz=258] unless entity @s[scores={MusicCheck=8}] run function kalos:triggers/stopsound
...
execute as @s[x=-1816,y=0,z=-987,dx=332,dy=256,dz=254] unless entity @s[scores={MusicCheck=10}] run function kalos:triggers/stopsound
...
execute as @s[x=-1204,y=0,z=-888,dx=230,dy=256,dz=380] unless entity @s[scores={MusicCheck=11}] run function kalos:triggers/stopsound
...
execute as @s[x=-342,y=0,z=-1577,dx=432,dy=256,dz=274] unless entity @s[scores={MusicCheck=12}] run function kalos:triggers/stopsound
...
execute as @s[x=582,y=0,z=-573,dx=152,dy=256,dz=313] unless entity @s[scores={MusicCheck=13}] run function kalos:triggers/stopsound
...
execute as @s[x=1097,y=0,z=-376,dx=334,dy=256,dz=235] unless entity @s[scores={MusicCheck=14}] run function kalos:triggers/stopsound
...
execute as @s[x=1326,y=0,z=132,dx=360,dy=256,dz=198] unless entity @s[scores={MusicCheck=15}] run function kalos:triggers/stopsound
...
execute as @s[x=984,y=0,z=324,dx=341,dy=256,dz=323] unless entity @s[scores={MusicCheck=16}] run function kalos:triggers/stopsound
...
execute as @s[x=-2255,y=0,z=1732,dx=629,dy=256,dz=655] unless entity @s[scores={MusicCheck=17}] run function kalos:triggers/stopsound
...
execute as @s[x=1027,y=0,z=1434,dx=331,dy=256,dz=266] unless entity @s[scores={MusicCheck=18}] unless entity @s[scores={MusicCheck=9}] run function kalos:triggers/stopsound
...
execute as @s[x=331,y=0,z=739,dx=256,dy=256,dz=239] unless entity @s[scores={MusicCheck=19}] run function kalos:triggers/stopsound
...
execute as @s[x=-1816,y=0,z=-1209,dx=332,dy=256,dz=221] unless entity @s[scores={MusicCheck=20}] run function kalos:triggers/stopsound
...
execute as @s[x=550,y=70,z=394,dx=63,dy=16,dz=87] unless entity @s[scores={MusicCheck=21}] run function kalos:triggers/stopsound
...
execute as @s[x=-1758,y=95,z=-529,dx=409,dy=161,dz=307] unless entity @s[scores={MusicCheck=22}] run function kalos:triggers/stopsound
...
execute as @s[x=-1897,y=0,z=-63,dx=257,dy=86,dz=201] unless entity @s[scores={MusicCheck=23}] run function kalos:triggers/stopsound
...
execute as @s[x=-1542,y=0,z=249,dx=174,dy=256,dz=310] unless entity @s[scores={MusicCheck=24}] run function kalos:triggers/stopsound
...
execute as @s[x=-1847,y=0,z=-675,dx=414,dy=89,dz=507] unless entity @s[scores={MusicCheck=25}] run function kalos:triggers/stopsound
...
execute as @s[x=-242,y=87,z=-2026,dx=180,dy=30,dz=188] unless entity @s[scores={MusicCheck=29..30}] run function kalos:triggers/stopsound
...
execute as @s[x=582,y=100,z=-1444,dx=326,dy=256,dz=870] unless entity @s[scores={MusicCheck=32}] run function kalos:triggers/stopsound
...
execute as @s[x=444,y=100,z=-1444,dx=137,dy=128,dz=560] unless entity @s[scores={MusicCheck=32}] run function kalos:triggers/stopsound
...
execute as @s[x=1720,y=0,z=-232,dx=421,dy=100,dz=324] unless entity @s[scores={MusicCheck=36}] run function kalos:triggers/stopsound
...
execute as @s[x=1524,y=68,z=6,dx=177,dy=19,dz=100] unless entity @s[scores={MusicCheck=36}] run function kalos:triggers/stopsound
...
execute as @s[x=703,y=90,z=563,dx=280,dy=100,dz=279] unless entity @s[scores={MusicCheck=37}] run function kalos:triggers/stopsound
...
execute as @s[x=809,y=74,z=525,dx=66,dy=14,dz=92] unless entity @s[scores={MusicCheck=38}] run function kalos:triggers/stopsound
...
execute as @s[x=1500,y=0,z=1203,dx=982,dy=256,dz=1417] unless entity @s[scores={MusicCheck=39}] run function kalos:triggers/stopsound
...
execute as @s[x=-792,y=100,z=1196,dx=38,dy=20,dz=47] unless entity @s[scores={MusicCheck=64}] run function kalos:triggers/stopsound
...
execute as @s[x=251,y=0,z=524,dx=202,dy=256,dz=214] unless entity @s[scores={MusicCheck=40}] run function kalos:triggers/stopsound
...
execute as @s[x=103,y=0,z=-114,dx=155,dy=256,dz=497] unless entity @s[scores={MusicCheck=41}] run function kalos:triggers/stopsound
...
execute as @s[x=-963,y=0,z=-219,dx=400,dy=256,dz=230] unless entity @s[scores={MusicCheck=42}] run function kalos:triggers/stopsound
...
execute as @s[x=-1348,y=0,z=-432,dx=201,dy=256,dz=313] unless entity @s[scores={MusicCheck=43..44}] run function kalos:triggers/stopsound
...
execute as @s[x=-1732,y=88,z=-118,dx=585,dy=168,dz=199] unless entity @s[scores={MusicCheck=43..44}] run function kalos:triggers/stopsound
...
execute as @s[x=-2231,y=83,z=59,dx=362,dy=173,dz=444] unless entity @s[scores={MusicCheck=45}] run function kalos:triggers/stopsound
...
execute as @s[x=-1875,y=0,z=560,dx=507,dy=256,dz=202] unless entity @s[scores={MusicCheck=46}] run function kalos:triggers/stopsound
...
execute as @s[x=-2298,y=0,z=-597,dx=262,dy=256,dz=379] unless entity @s[scores={MusicCheck=47}] run function kalos:triggers/stopsound
...
execute as @s[x=-2112,y=0,z=-757,dx=264,dy=256,dz=159] unless entity @s[scores={MusicCheck=48}] run function kalos:triggers/stopsound
...
execute as @s[x=-1483,y=0,z=-888,dx=278,dy=256,dz=154] unless entity @s[scores={MusicCheck=49}] unless entity @s[scores={MusicCheck=27}] run function kalos:triggers/stopsound
...
execute as @s[x=-973,y=0,z=-871,dx=371,dy=256,dz=651,tag=!Indoors] unless entity @s[scores={MusicCheck=50}] run function kalos:triggers/stopsound
...
execute as @s[x=212,y=95,z=-695,dx=369,dy=156,dz=292,tag=!Indoors] unless entity @s[scores={MusicCheck=52..53}] run function kalos:triggers/stopsound
...
execute as @s[x=212,y=95,z=-402,dx=369,dy=160,dz=273,tag=!Indoors] unless entity @s[scores={MusicCheck=52..53}] run function kalos:triggers/stopsound
...
execute as @s[x=735,y=0,z=-417,dx=361,dy=256,dz=495] unless entity @s[scores={MusicCheck=54}] run function kalos:triggers/stopsound
...
execute as @s[x=1298,y=0,z=-140,dx=300,dy=256,dz=271] unless entity @s[scores={MusicCheck=55}] run function kalos:triggers/stopsound
...
execute as @s[x=1326,y=0,z=331,dx=296,dy=256,dz=249] unless entity @s[scores={MusicCheck=56}] run function kalos:triggers/stopsound
...
execute as @s[x=984,y=95,z=707,dx=621,dy=50,dz=451] unless entity @s[scores={MusicCheck=57}] run function kalos:triggers/stopsound
...
execute as @s[x=705,y=95,z=299,dx=278,dy=100,dz=263] unless entity @s[scores={MusicCheck=58}] run function kalos:triggers/stopsound
...
execute as @s[x=683,y=95,z=393,dx=21,dy=100,dz=170] unless entity @s[scores={MusicCheck=58}] run function kalos:triggers/stopsound
...
execute as @s[x=454,y=87,z=524,dx=228,dy=100,dz=214] unless entity @s[scores={MusicCheck=59}] run function kalos:triggers/stopsound
...
execute as @s[x=344,y=87,z=299,dx=338,dy=100,dz=224] unless entity @s[scores={MusicCheck=59}] run function kalos:triggers/stopsound
...
execute as @s[x=-2027,y=0,z=-1934,dx=205,dy=256,dz=147] unless entity @s[scores={MusicCheck=60}] run function kalos:triggers/stopsound
...
execute as @s[x=-1821,y=0,z=-2071,dx=273,dy=256,dz=285] unless entity @s[scores={MusicCheck=60}] run function kalos:triggers/stopsound
...
execute as @s[x=-1473,y=0,z=-1984,dx=183,dy=256,dz=191] unless entity @s[scores={MusicCheck=60}] run function kalos:triggers/stopsound
...
execute as @s[x=-2027,y=0,z=-2285,dx=205,dy=256,dz=212] unless entity @s[scores={MusicCheck=60}] run function kalos:triggers/stopsound
...
execute as @s[x=-1877,y=0,z=-1775,dx=110,dy=256,dz=130] unless entity @s[scores={MusicCheck=60}] run function kalos:triggers/stopsound
...
execute as @s[x=-2018,y=0,z=-1757,dx=115,dy=256,dz=113] unless entity @s[scores={MusicCheck=60}] run function kalos:triggers/stopsound
...
execute as @s[x=-1227,y=0,z=-2125,dx=301,dy=256,dz=438] unless entity @s[scores={MusicCheck=60}] run function kalos:triggers/stopsound
...
execute as @s[x=-871,y=0,z=-2110,dx=143,dy=256,dz=321] unless entity @s[scores={MusicCheck=60}] run function kalos:triggers/stopsound
...
execute as @s[x=683,y=0,z=299,dx=21,dy=256,dz=93] unless entity @s[scores={MusicCheck=39}] run function kalos:triggers/stopsound
...
execute as @s[x=543,y=0,z=-37,dx=328,dy=256,dz=272] unless entity @s[scores={MusicCheck=39}] run function kalos:triggers/stopsound
