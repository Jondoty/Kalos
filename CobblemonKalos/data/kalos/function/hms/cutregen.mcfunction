...
execute as @a[x=355,y=94,z=559,distance=30..150] as @e[x=355,y=94,z=559,distance=..10,type=minecraft:armor_stand,tag=CutTree] at @s unless entity @e[distance=..1,type=minecraft:interaction] run summon minecraft:interaction ~ ~ ~ {width:1.5,height:2.0,response:1,Tags:[CutTree]}
...
execute as @a[x=-894,y=100,z=-44,distance=30..150] as @e[x=-894,y=100,z=-44,distance=..3,type=minecraft:armor_stand,tag=CutTree] at @s unless entity @e[distance=..1,type=minecraft:interaction] run summon minecraft:interaction ~ ~ ~ {width:1.5,height:2.0,response:1,Tags:[CutTree]}
...
execute as @a[x=-894,y=100,z=-62,distance=30..150] as @e[x=-894,y=100,z=-62,distance=..3,type=minecraft:armor_stand,tag=CutTree] at @s unless entity @e[distance=..1,type=minecraft:interaction] run summon minecraft:interaction ~ ~ ~ {width:1.5,height:2.0,response:1,Tags:[CutTree]}
...
execute as @a[x=-1671,y=109,z=3,distance=30..150] as @e[x=-1671,y=109,z=3,distance=..10,type=minecraft:armor_stand,tag=CutTree] at @s unless entity @e[distance=..1,type=minecraft:interaction] run summon minecraft:interaction ~ ~ ~ {width:1.5,height:2.0,response:1,Tags:[CutTree]}
...
execute as @a[x=-1988,y=113,z=-668,distance=30..150] as @e[x=-1988,y=113,z=-668,distance=..10,type=minecraft:armor_stand,tag=CutTree] at @s unless entity @e[distance=..1,type=minecraft:interaction] run summon minecraft:interaction ~ ~ ~ {width:1.5,height:2.0,response:1,Tags:[CutTree]}
...
execute as @a[x=-1453,y=80,z=-790,distance=30..150] as @e[x=-1453,y=80,z=-790,distance=..10,type=minecraft:armor_stand,tag=CutTree] at @s unless entity @e[distance=..1,type=minecraft:interaction] run summon minecraft:interaction ~ ~ ~ {width:1.5,height:2.0,response:1,Tags:[CutTree]}
...
execute as @a[x=-1366,y=80,z=-754,distance=30..150] as @e[x=-1366,y=80,z=-754,distance=..10,type=minecraft:armor_stand,tag=CutTree] at @s unless entity @e[distance=..1,type=minecraft:interaction] run summon minecraft:interaction ~ ~ ~ {width:1.5,height:2.0,response:1,Tags:[CutTree]}
...
execute as @a[x=383,y=104,z=-328,distance=30..150] as @e[x=383,y=104,z=-328,distance=..10,type=minecraft:armor_stand,tag=CutTree] at @s unless entity @e[distance=..1,type=minecraft:interaction] run summon minecraft:interaction ~ ~ ~ {width:1.5,height:2.0,response:1,Tags:[CutTree]}
...
execute as @a[x=1408,y=108,z=-56,distance=30..150] as @e[x=1408,y=108,z=-56,distance=..10,type=minecraft:armor_stand,tag=CutTree] at @s unless entity @e[distance=..1,type=minecraft:interaction] run summon minecraft:interaction ~ ~ ~ {width:1.5,height:2.0,response:1,Tags:[CutTree]}
...
execute as @a[x=389,y=100,z=328,distance=30..150] as @e[x=389,y=100,z=328,distance=..10,type=minecraft:armor_stand,tag=CutTree] at @s unless entity @e[distance=..1,type=minecraft:interaction] run summon minecraft:interaction ~ ~ ~ {width:1.5,height:2.0,response:1,Tags:[CutTree]}
